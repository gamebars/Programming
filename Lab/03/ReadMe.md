...
class GameControls:
    def __init__(self, master):
        ...
        self.step = Button(master, text="Сделать ход", font=("Google Sans", 40), bg='#515156', fg='white', padx=2,
                           pady=1, relief='raised')
        self.step.grid(row=6, column=1, columnspan=3, pady=10)
        self.new_game = Button(master, text="Новая игра", font=("Google Sans", 40), bg='#515156', fg='white', padx=2,
                               pady=1, relief='raised')
...
[Ссылка на исходный код](./main.py)
